        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <?php echo e(__('Owner')); ?>: <?php echo e(auth()->user()->name); ?>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="<?php echo e(route('chirps.update', $chirp)); ?>" method="post" class="bg-transparent"
                        ...
                        <textarea name="message" id="message"
                            ...
                            placeholder="<?php echo e(__('What´s on your mind?')); ?>"><?php echo e(old('message', $chirp->message)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\aprendible\bootcamp\resources\views/chirps/edit.blade.php ENDPATH**/ ?>