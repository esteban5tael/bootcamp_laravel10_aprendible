        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="<?php echo e(route('chirps.store')); ?>" method="post" class="bg-transparent"
                        ...
                        <textarea name="message" id="message"
                            ...
                            placeholder="<?php echo e(__('What´s on your mind?')); ?>"><?php echo e(old('message')); ?></textarea>
                        ...
                        <div class="p-6 flex space-x-2">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-center">
                                    <div>
                                        <span class="text-gray-800 dark:text-gray-200"><?php echo e($chirp->user->name); ?> </span>
                                        <small
                                            class="ml-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e($chirp->created_at->diffForHumans()); ?></small>
                                    </div>
                                </div>
                                <p class="mt-4 text-lg text-gray-900 dark:text-gray-100"><?php echo e($chirp->message); ?></p>
                            </div>

                            <?php if(auth()->user()->is($chirp->user)): ?>
                                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\aprendible\bootcamp\resources\views/chirps/index.blade.php ENDPATH**/ ?>